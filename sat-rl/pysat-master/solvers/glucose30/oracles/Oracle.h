#ifndef Glucose30_Oracle_h
#define Glucose30_Oracle_h
...
public:
    Oracle(Solver *solver, std::function<double*()> cb, bool collectStats) :
        solver(solver),
        callback(cb),
    ...
    void      reduceDB ()
    {
        ...
        double* action = (double*) Oracle::callback();
