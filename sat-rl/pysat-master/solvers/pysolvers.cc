...
#include "glucose30/oracles/Oracle.h"
#include "glucose30/oracles/DefaultOracle.h"
#include "glucose30/oracles/PercentageOracle.h"
#include "glucose30/oracles/CounterFactualOracle.h"
#include "glucose30/oracles/ThreeValuedOracle.h"
#include "glucose30/oracles/LBDThresholdOracle.h"
...
static PyObject *py_glucose3_gc_oracle(PyObject *self, PyObject *args)
{
    ...
    Glucose30::Oracle *oracle = s->getGCOracle();
    if (oracle)
        delete oracle;
