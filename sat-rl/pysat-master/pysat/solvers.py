    ...
    def new(self, branching_oracle={}, use_timer=False, verbose = False, time_budget = -1):
        ...
        if not self.sharpSAT:
            ...
            pysolvers.sharpsat_branching_oracle(self.sharpSAT,
                branching_oracle.get("capture_cb", lambda: None),
...
class Glucose3(object):
    ...
    def __init__(self, bootstrap_with=None, use_timer=False, incr=False, with_proof=False,
        gc_oracle=None, reduce_base=2000, gc_freq="glucose"):
        """
            Basic constructor.
        """
        ...
        self.new(bootstrap_with, use_timer, incr, with_proof, gc_oracle, reduce_base, gc_freq)
    ...
    def reward(self):
        ...
        if self.glucose:
            return pysolvers.glucose3_reward(self.glucose)
